...
export const dummyTestimonials = [
  {
    id: 1,
    quote:
      "Buying a home from Greatway Properties was one of the best decisions I've ever made. I moved in with zero stress, and everything looked exactly as promised.",
  ...
  },
  {
    id: 2,
    quote:
      "The team at Greatway guided us through every step of the process. The quality of the finishing and the attention to detail in our new home is outstanding.",
  ...
  },
  {
    id: 3,
    quote:
      "I was skeptical at first, but Greatway Properties delivered beyond my expectations. The location, design, and value for money are unmatched in Lagos.",
    name: "Amaka Nwosu",
  ...
  },
  {
    id: 4,
    quote:
      "From the first site visit to collecting my keys, the experience was seamless. I have recommended Greatway to three of my colleagues already.",
    name: "Biodun Adeyemi",
    role: "Happy Customer",
  ...
  },
  {
    id: 5,
    quote:
      "Professional, transparent, and reliable. Greatway Properties restored my faith in real estate development in Nigeria. My family couldn't be happier.",
    name: "Ngozi Eze",
    role: "Homeowner",
